  ...
  return (
    <>
      <HeroSlider
        ...
        className="!mb-20 !md:mb-28 !xl:mb-36"
      />
      <Container className="border-b border-gray-200 pb-20 md:pb-28 xl:pb-36">
        <CategoryBlockIcon
      ...
      <Container>
        ...
        <BannerCard
          ...
          className="mb-20 md:mb-28 xl:mb-36 pb-0.5 md:pb-0 lg:pb-1 xl:pb-0 md:-mt-2.5"
        />
        ...
        <CollectionBlock
          ...
          className="mb-20 md:mb-28 xl:mb-36 lg:pt-1 xl:pt-0"
        />
        <RecentProductFeed />
        <DownloadApps
          className="mb-20 md:mb-28 xl:mb-36 bg-app-pattern"
          variant="modern"
        />
        <TestimonialCarousel
