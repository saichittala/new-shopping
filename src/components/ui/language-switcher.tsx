    ...
    <Listbox value={selectedItem} onChange={handleItemClick}>
      {({ open }) => (
        <div className="relative ltr:ml-2 rtl:mr-2 ltr:lg:ml-0 rtl:lg:mr-0 z-10 w-[140px] sm:w-[150px] lg:w-[130px] xl:w-[150px]">
          <ListboxButton className="border border-gray-300 text-gray-700 text-[13px] xl:text-sm font-semibold relative w-full h-11 ltr:pl-3.5 rtl:pr-3.5 ltr:pr-8 rtl:pl-8 ltr:text-left rtl:text-right bg-white rounded-md shadow-xs hover:bg-gray-50 hover:text-gray-900 transition-colors focus:outline-none cursor-pointer">
            <span className="flex truncate items-center gap-x-2">
