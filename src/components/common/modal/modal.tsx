...
import { appleModalAnimation } from '@utils/motion/apple-modal-animation';
        ...
        >
          ...
          >
            ...
            >
              ...
              <div
                ref={modalInnerRef}
                className="h-full overflow-y-auto rounded-lg modal-inner-content"
              >
                {children}
              </div>
            </div>
